...
twitterImg: post/2018-12-14-normal-canadian-city/figure-html/hamilton-1.png
description: ""
categories:
  - blog
  - analysis
...
```{r hamilton, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.height=7, fig.retina=TRUE}
library(ggplot2)
library(lato)
library(patchwork)
national_demo %>%
...
```{r vancouver, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.height=7, fig.retina=TRUE}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, height=12, out.width="100%"}
library(umap)
library(ggrepel)
library(lato)
...
The code for getting Census data, transforming it, and calculating the similarity scores is below. The code for this entire page is, as always, view-able on Github. The UMAP visualization takes advantage of the excellent [umap](https://cran.r-project.org/web/packages/umap/vignettes/umap.html) R package. 

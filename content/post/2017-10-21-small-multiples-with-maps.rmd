...
<center>
![Persons with gainful occupations and attending school, Walker (1874)](https://upload.wikimedia.org/wikipedia/commons/2/2f/Persons_With_Gainful_Occupations_and_Attending_School_in_1870.jpg){ height=30% }
_An early example of a small multiples plot from 1874_
</center>

<center>
![Evolution of Homeownership Rates Across the United States](https://blog.dominodatalab.com/wp-content/uploads/2016/05/home_ownership.png){ height=30% }
...
```{r show_top_languages, message=FALSE, warning=FALSE, results = "hide"}
toronto10
```
